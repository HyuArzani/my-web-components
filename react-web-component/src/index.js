...
import ReactWebComponent from './direflow-components/react-web-component';

ReactWebComponent.then((element) => {

  /**
   * Access DOM node when it's mounted
   */
  console.log('react-web-component is mounted on the DOM', element);
});
